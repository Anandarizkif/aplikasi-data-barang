...
public class frm_pelanggan extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/icons8_People_50px.png"))); // NOI18N
        jLabel3.setText("INPUT DATA PELANGGAN");
        jPanel2.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 0, 370, 50));
        ...
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 60, 100, 20));
        ...
        kd_pelanggan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                kd_pelangganActionPerformed(evt);
            }
        });
        getContentPane().add(kd_pelanggan, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 60, 110, 30));
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 110, 400, 420));
        ...
        getContentPane().add(tambah, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 350, 110, 40));
        ...
        getContentPane().add(reset, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 350, 90, 40));
        ...
        getContentPane().add(hapus, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 350, 100, 40));
        ...
        getContentPane().add(update, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 350, 100, 40));
        ...
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 490, 50, 30));

        setSize(new java.awt.Dimension(966, 601));
    ...
    public void AutoKode(){
           try{
                ...
                if(rs.next()){
                    ...
                    kd_pelanggan.setText("PL" + Nol + AN);
                }
                else{
                    kd_pelanggan.setText("PL0001");
                }
                kd_pelanggan.enable(false);
                rs.close();
           }
           catch (Exception e) {
    ...
    private void tambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tambahActionPerformed
        ...
        else if(kd_pelanggan.getText().toString().equals("") || nama.getText().toString().equals("") || alamat.getText().toString().equals("")){
           JOptionPane.showMessageDialog(null,"Silahkan Lengkapi Data!");
        }
        else{
            conn = config.Conn();
            try {
                ...
                st = conn.createStatement();
                st.executeUpdate("INSERT INTO pelanggan SET " + " kd_pelanggan='"+ kd_pelanggan.getText() +"', nama_pelanggan='"+ nama.getText() +"', jenis_kelamin='"+ hasil +"', alamat='"+ alamat.getText() +"'");
                judul();
                tampil();
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        ...
        try {
            ...
            st = conn.createStatement();
            st.executeUpdate("UPDATE pelanggan SET " + " nama_pelanggan='"+ nama.getText() +"', jenis_kelamin='"+ hasil +"', alamat='"+ alamat.getText() +"' WHERE kd_pelanggan='"+ kd_pelanggan.getText() +"'");
    ...
    private void tpelangganMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tpelangganMouseClicked
        kd_pelanggan.setText(tabmodel.getValueAt(tpelanggan.getSelectedRow(), 0)+ "");
    ...
    private void kd_pelangganActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kd_pelangganActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_kd_pelangganActionPerformed
