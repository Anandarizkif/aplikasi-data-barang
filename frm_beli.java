 ...
 * @author Ican
 */
public class frm_beli extends javax.swing.JFrame {
    public Statement st;
    public ResultSet rs;
    ...
    private void initComponents() {
        ...
        jPanel1.add(kd_pelanggan, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 251, 151, 30));

        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel5.setText("Kode Pelanggan");
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 230, 130, 21));

        jLabel6.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel6.setText("Kode Barang");
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(276, 224, 95, 21));
        jPanel1.add(txt_barang, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 251, 151, 30));
        ...
        tambah.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/Shopping Cart_20px.png"))); // NOI18N
        ...
        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/Shopping Cart_20px.png"))); // NOI18N
        ...
        jLabel16.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/Transaction_64px.png"))); // NOI18N
    ...
    private void tambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tambahActionPerformed
        if (kd_pelanggan.getText().equals("") || txt_barang.getText().equals("") || tharga.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Harap Lengkapi Data...");
        }
        try {
            st = conn.createStatement();
            st.executeUpdate("INSERT INTO penjualan SET " + " kd_pretransaksi='"+ pretransaksi.getText() +"', kd_transaksi='"+ transaksi.getText() +"', kd_pelanggan='"+ kd_pelanggan.getText() +"', kd_barang='"+ txt_barang.getText() +"', jumlah='"+ jumlah.getText() +"', sub_total='"+ total.getText() +"'");
    ...
    public void namabarang(){
        Object[] nama = {"kd Barang","Nama","Stok","HargaJual"};
    ...
    public void jkeranjang(){
        Object[] judul = {"Kode Pretransaksi","Kode Transaksi","Kode Pelanggan","Kode Barang","Jumlah","Sub Total"};
    ...
    public void tampild_barang(){
        try {
            st = conn.createStatement();
            tabmodel.getDataVector().removeAllElements();
            tabmodel.fireTableDataChanged();
            rs = st.executeQuery("SELECT kd_barang,nama_barang,stok_barang,harga_jual FROM barang");
            while (rs.next()) {                
                Object[] data = {
                    rs.getString("kd_barang"),
    ...
    public void jpelanggan(){
        Object[] nama = {"kd Pelanggan","Nama"};
        tabmodel1 = new DefaultTableModel(null,nama){
            @Override
            public boolean isCellEditable(int row, int column) {
                return false;
            }
    ...
    private void tbl_pelangganMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_pelangganMouseClicked
        kd_pelanggan.setText(tabmodel1.getValueAt(tbl_pelanggan.getSelectedRow(), 0) + "");
...
//       }
    ...
    private void t_barangMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_t_barangMouseClicked
        txt_barang.setText(tabmodel.getValueAt(t_barang.getSelectedRow(), 0).toString());
        stok_tampung.setText(tabmodel.getValueAt(t_barang.getSelectedRow(),2).toString());
        tharga.setText(tabmodel.getValueAt(t_barang.getSelectedRow(), 3).toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_beli.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
